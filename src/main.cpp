...
int main()
{
    ...
    // --------------------
    GLFWwindow* window = glfwCreateWindow(SCR_WIDTH, SCR_HEIGHT, "Spotlight Texture", NULL, NULL);
    if (window == NULL)
    {
    ...
    unsigned int spotlightMap = loadTexture("resources/textures/winton.png");
    ...
    lightingShader.setInt("material.spotTexture", 2);
